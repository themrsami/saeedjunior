    ...
    <nav className='flex justify-between w-full p-4 sm:px-12 sm:py-8 md:px-28 md:py-16 items-center h-16 text-white fixed top-0 left-0 z-10 shadow-sm'>
      ...
      <div className='flex'>
        <Link href='/' className={getLinkClass('/') + ' home-link'}>
          ...
          <span className="home-link-hover-text">Home</span>
        </Link>
        <Link href='/work' className={getLinkClass('/work') + ' home-link'}>
          <span className="home-link-text">Work</span>
          <span className="home-link-hover-text">Work</span>
        </Link>
        <Link href='/about' className={getLinkClass('/about') + ' home-link'}>
          <span className="home-link-text">About</span>
          <span className="home-link-hover-text">About</span>
        </Link>
      </div>
    </nav>
  )
